...
foreach ($categorias as $valores) {
    $html .= '<div class="list-group"><ul><li class="permiso" title="'.lang('editar').' '.lang('categoria').'"><a href="'.base_url().'index.php/permisos/abm/'.$valores['id_categoria'].'">'.$valores['menu'].'</a>';
    
    if(isset($menus[$valores['id_categoria']])){
        $html .= '<ul>';
        foreach ($menus[$valores['id_categoria']] as $menu) {
            $html .= '<li class="permiso" title="'.lang('editar').' '.lang('menu').'"><a href="'.base_url().'index.php/permisos/abm/'.$menu['id'].'">'.$menu['menu'].'</a></li>';           
        }
        $html .= '</ul>';
    }
